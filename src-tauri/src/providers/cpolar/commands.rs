...
use crate::providers::cpolar::{credentials, environment};
use crate::providers::registry;
use crate::state::AppState;
use tauri::{AppHandle, State};

#[tauri::command]
pub async fn cpolar_install_runtime(
    app: AppHandle,
...
#[tauri::command]
pub fn cpolar_uninstall_runtime(
    app: AppHandle,
...
#[tauri::command]
pub fn cpolar_check_runtime_update(
    app: AppHandle,
    state: State<AppState>,
...
#[tauri::command]
pub async fn cpolar_authenticate_tunnel(
    app: AppHandle,
    state: State<'_, AppState>,
    ...
    .await
    .map_err(|error| AppError::Msg(format!("cpolar authentication task failed: {error}")))?
}
